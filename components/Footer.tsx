  ...
  return (
    <div className='pt-[8rem] pb-[4rem] bg-[#02050a]'>
        <div className='grid border-b-[1px] pb-[6rem] border-gray-400 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 w-[80%] mx-auto gap-[3rem]'>
            <div className='flex items-center space-x-6'>
                ...
                <div>
                    ...
                    <p className='text-[17px] w-[90%] text-white opacity-60'>Gikondo, Kicukiro District</p>
                </div>
            </div>
            <div className='flex items-center space-x-6'>
                <div className='md:w-[6.5rem] md:h-[6.5rem] w-[5rem] h-[5rem] flex items-center justify-center rounded-full bg-[#55e6a5]'>
        ...
        <div className='w-[80%] mt-[2rem] mx-auto grid grid-cols-1 md:grid-cols-2 items-center justify-between'>
            <div className='text-[14px] mb-[2rem] md:mb-0 text-white opacity-20 '> Ngoga Commerce 2024 | All rights reserved</div>
            <div className='flex items-center space-x-10'>
                <p className='text-[14px] text-white opacity-20'>Terms & conditions</p>
